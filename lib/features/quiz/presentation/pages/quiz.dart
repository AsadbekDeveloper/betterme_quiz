...
class _QuizPageState extends State<QuizPage> {
  ...
  void initState() {
    super.initState();
    // Initial load based on current locale
    final currentLocale = context.read<LocaleBloc>().state.locale.languageCode;
    context.read<QuizBloc>().add(LoadQuizEvent(locale: currentLocale));
  }
